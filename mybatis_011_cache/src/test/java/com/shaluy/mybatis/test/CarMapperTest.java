...
public class CarMapperTest {
    ...
    public void testSelectById(){
        ...
        Car car1 = mapper1.selectById(87L);
        ...
        Car car2 = mapper2.selectById(87L);
    ...
    public void testSelectById2() throws IOException {
        ...
        Car car1 = mapper1.selectById2(89L);
        System.out.println(car1);
        ...
        Car car2 = mapper2.selectById2(89L);
        System.out.println(car2);

        // 程序执行玩下面的代码，会将sqlSession1这个一级缓存中的数据写入到二级缓存当中。
//        sqlSession1.close();
        // 程序执行玩下面的代码，会将sqlSession2这个一级缓存中的数据写入到二级缓存当中。
        sqlSession2.close();
